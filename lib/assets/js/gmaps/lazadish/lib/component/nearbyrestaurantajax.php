...
if ($queries->have_posts()):
    while ($queries->have_posts()) : $queries->the_post() ; $id = get_the_ID(); $locations = get_post_meta(get_the_ID(),'_ld_map');?>
            ...
            <li class="col-md-3">
               ...
               <p class="mb-1 text-silver"><i class="text-red ion-ios-location"></i>&nbsp;<?php echo $locations[0]['address'] ?></p>
...
<?php else : echo '<div class="container text-center"><h4 class="pt-5">Oops! No Restaurant Nearby</h4><i style="font-size:4rem;color:#C00A27" class="ion-sad-outline"></i></div>' ?>
<?php endif; ?>
...
<?php endwhile; ?>
<?php else : echo '<h4 class="text-center pt-5">Oops! No Restaurant Nearby</h4><i style="font-size:4rem;color:#C00A27" class="ion-sad-outline"></i>' ?>
<?php endif; ?>
