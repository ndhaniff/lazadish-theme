			...
			<div class="section-title text-center ">
				<ul class="cat-list row mb-0">
					<li class="col-xs-6 col-md-2">
						<a href="<?php echo  get_home_url() . '/product-category/dessert' ?>"><i style="font-size:5rem" class="text-silver lazadish ldish-cupcake"></i>
						<h5 class="text-silver pt-1">Dessert</h5></a>

					</li>
					<li class="col-md-2">
						<a href="<?php echo  get_home_url() . '/product-category/dry-food' ?>"><i style="font-size:5rem" class="text-silver lazadish ldish-dried-fruit"></i>
						<h5 class="text-silver pt-1">Dry Food</h5></a>
					</li>
					<li class="col-md-2">
						<a href="<?php echo  get_home_url() . '/product-category/frozen' ?>"><i style="font-size:5rem" class="text-silver lazadish ldish-meat"></i>
						<h5 class="text-silver pt-1">Frozen</h5></a>
					</li>
					<li class="col-md-2">
						<a href="<?php echo  get_home_url() . '/product-category/groceries' ?>"><i style="font-size:5rem" class="text-silver lazadish ldish-groceries"></i>
						<h5 class="text-silver pt-1">Groceries</h5></a>
					</li>
					<li class="col-md-2">
						<a href="<?php echo  get_home_url() . '/product-category/international' ?>"><i style="font-size:5rem" class="text-silver lazadish ldish-salver"></i>
						<h5 class="text-silver pt-1">International</h5></a>
					</li>
					<li class="col-md-2">
						<a href="<?php echo  get_home_url() . '/product-category/main-dish' ?>"><i style="font-size:5rem" class="text-silver lazadish ldish-bell-covering-hot-dish"></i>
		...
		<div class="col-md-12 section-content py-4">
			<div class="section-title text-center ">
				...
				<div id="geolocater" class='container' data-url="<?php echo admin_url('admin-ajax.php'); ?>">
					<ul class="list-restaurant text-center  row" id="scanlocation">
